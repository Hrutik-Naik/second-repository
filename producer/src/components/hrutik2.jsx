    ...
    return(
        <>
          <div className='main'> 
            <div className="top">
                <div className="t-l">
                    <div className="t1">Producer Dashboard</div>
            ...
            <div className="middle">
                <button className="m1">Pending (6)</button>
                <button className="m2">Approved (7)</button>
                <button className="m3">Rejected (2)</button>
            </div>
            <div className="bottom">
                ...
                <div className="b-b">
                    ...
                    <div className="b1">
                        <div className="ba1">
                            <img src={img2} alt="" className='iron'/>
                        </div>
